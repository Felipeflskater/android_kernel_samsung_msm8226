...
/* DISABLED: EXPORT_SYMBOL(strnlen_user_asm); */
/* DISABLED: EXPORT_SYMBOL(strncpy_from_user_asm); */
/* DISABLED: EXPORT_SYMBOL(clear_user_asm); */
/* DISABLED: EXPORT_SYMBOL(flush_user_asm); */
/* DISABLED: EXPORT_SYMBOL(inv_user_asm); */
/* DISABLED: EXPORT_SYMBOL(finv_user_asm); */

/* arch/tile/kernel/entry.S */
#include <linux/kernel.h>
#include <asm/processor.h>
/* DISABLED: EXPORT_SYMBOL(current_text_addr); */
...
/* DISABLED: EXPORT_SYMBOL(__copy_to_user_inatomic); */
/* DISABLED: EXPORT_SYMBOL(__copy_from_user_inatomic); */
/* DISABLED: EXPORT_SYMBOL(__copy_from_user_zeroing); */
#ifdef __tilegx__
/* DISABLED: EXPORT_SYMBOL(__copy_in_user_inatomic); */
#endif

/* hypervisor glue */
#include <hv/hypervisor.h>
/* DISABLED: EXPORT_SYMBOL(hv_dev_open); */
/* DISABLED: EXPORT_SYMBOL(hv_dev_pread); */
/* DISABLED: EXPORT_SYMBOL(hv_dev_pwrite); */
/* DISABLED: EXPORT_SYMBOL(hv_dev_preada); */
/* DISABLED: EXPORT_SYMBOL(hv_dev_pwritea); */
/* DISABLED: EXPORT_SYMBOL(hv_dev_poll); */
/* DISABLED: EXPORT_SYMBOL(hv_dev_poll_cancel); */
/* DISABLED: EXPORT_SYMBOL(hv_dev_close); */
/* DISABLED: EXPORT_SYMBOL(hv_sysconf); */
/* DISABLED: EXPORT_SYMBOL(hv_confstr); */
