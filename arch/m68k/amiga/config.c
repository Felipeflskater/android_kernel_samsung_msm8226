...
/* DISABLED: EXPORT_SYMBOL(amiga_eclock); */

unsigned long amiga_colorclock;
/* DISABLED: EXPORT_SYMBOL(amiga_colorclock); */

unsigned long amiga_chipset;
/* DISABLED: EXPORT_SYMBOL(amiga_chipset); */

unsigned char amiga_vblank;
/* DISABLED: EXPORT_SYMBOL(amiga_vblank); */

static unsigned char amiga_psfreq;

struct amiga_hw_present amiga_hw_present;
/* DISABLED: EXPORT_SYMBOL(amiga_hw_present); */
...
/* DISABLED: EXPORT_SYMBOL_GPL(key_maps); */
#endif
